  ...
  <div class="bg-white shadow rounded-lg p-6">
    ...
    <form onsubmit={handleSubmit} class="space-y-4">
      <div>
        ...
        <input type="text" id="name" bind:value={newCompany.name} class="input w-full" required />
      </div>
      <div>
        <label for="gstin" class="block text-sm font-medium text-gray-700">GSTIN</label>
        <input type="text" id="gstin" bind:value={newCompany.gstin} class="input w-full" required />
      </div>
      <div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input type="text" id="city" bind:value={newCompany.city} class="input w-full" required />
        </div>
        <div>
          <label for="state" class="block text-sm font-medium text-gray-700">State</label>
          <select id="state" bind:value={newCompany.state} class="input w-full" required>
