<script lang="ts">
  ...
  let classes = $derived(
    [
      'cursor-pointer px-4 py-2.5 font-medium rounded-lg shadow-xs transition-all duration-200 focus:outline-hidden focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed',
